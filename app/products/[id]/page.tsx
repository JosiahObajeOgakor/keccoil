...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      ...
      description: `${product.description || product.name}. ₦${priceNaira}. Food-grade certified red palm oil. Fast delivery across Nigeria. Order now from KeccOil.`,
      openGraph: {
        title: `${product.name} | KeccOil`,
    ...
    return {
      title: 'Product Details | KeccOil',
      description: 'View product details and order premium red palm oil from KeccOil.',
    };
  }
}
  ...
  try {
    ...
    jsonLd = {
      ...
      offers: {
        ...
        seller: { '@type': 'Organization', name: 'KeccOil' },
      },
    };
  } catch {
    // Fallback: no JSON-LD
