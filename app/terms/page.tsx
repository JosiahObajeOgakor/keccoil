...
export const metadata: Metadata = {
  ...
  description: 'KeccOil terms and conditions — rules governing the use of our website and services.',
};
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-10">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li><strong className="text-foreground">&quot;Platform&quot;</strong> refers to the KeccOil website, AI chat assistant, and all associated services.</li>
                ...
                <li><strong className="text-foreground">&quot;We&quot;, &quot;Us&quot;, &quot;Our&quot;</strong> refers to KeccOil Nigeria.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                All KeccOil products are food-grade certified and sourced from trusted local Nigerian producers. We stand behind the quality of our products. If you are unsatisfied with the quality of any product, please contact us within 48 hours of delivery and we will work to resolve the issue promptly.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                All content on our Platform, including text, graphics, logos, images, product descriptions, and software, is the property of KeccOil or its licensors and is protected by Nigerian and international copyright laws. You may not reproduce, distribute, modify, or create derivative works from any content without our prior written consent.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                To the maximum extent permitted by law, KeccOil shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or relating to your use of our Platform or Products. Our total liability shall not exceed the amount you paid for the specific order giving rise to the claim.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                You agree to indemnify and hold harmless KeccOil, its officers, directors, employees, and agents from and against any claims, damages, losses, liabilities, and expenses arising out of your use of our Platform, violation of these Terms, or infringement of any third-party rights.
              </p>
            </div>
