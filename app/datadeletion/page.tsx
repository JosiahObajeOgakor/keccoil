...
export const metadata: Metadata = {
  title: 'Data Deletion',
  description: 'KeccOil data deletion instructions — how to request deletion of your personal data.',
};
        ...
        <section className="border-b border-border bg-secondary/20">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
            ...
            <p className="text-lg text-muted-foreground">
              How to request deletion of your personal data from KeccOil
            </p>
          </div>
        </section>
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-10">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Under the Nigeria Data Protection Regulation (NDPR), you have the right to request the deletion of your personal data held by KeccOil. We are committed to respecting your privacy and will process all legitimate deletion requests promptly.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-3">
                Depending on your interactions with KeccOil, we may hold the following data about you:
              </p>
